...
@app.get("/nba-standings/eastern-conference/2026-04-21.png")
async def standings_east_2026_04_21():
    return FileResponse(
        "img/standings/nba-eastern-conference-cumulative-standings-2026-04-21.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-standings/eastern-conference/2026-04-19.png")
async def standings_east_2026_04_19():
    return FileResponse(
        "img/standings/nba-eastern-conference-cumulative-standings-2026-04-19.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
...
async def standings_east_2026_04_07():
    return FileResponse(
        "img/standings/nba-eastern-conference-cumulative-standings-2026-04-07.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-standings/eastern-conference/2026-03-31.png")
async def standings_east_2026_03_31():
    return FileResponse(
        "img/standings/nba-eastern-conference-cumulative-standings-2026-03-31.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
...
@app.get("/nba-standings/western-conference/2026-04-21.png")
async def standings_west_2026_04_21():
    return FileResponse(
        "img/standings/nba-western-conference-cumulative-standings-2026-04-21.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-standings/western-conference/2026-04-19.png")
...
@app.get("/nba-standings/western-conference/2026-04-07.png")
async def standings_west_2026_04_07():
    return FileResponse(
        "img/standings/nba-western-conference-cumulative-standings-2026-04-07.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-standings/western-conference/2026-03-31.png")
async def standings_west_2026_03_31():
    return FileResponse(
        "img/standings/nba-western-conference-cumulative-standings-2026-03-31.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
...
@app.get("/nba-head-to-head/2026-04-21.png")
async def head_to_head_2026_04_21():
    return FileResponse(
        "img/head-to-head/nba-head-to-head-2026-04-21.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-head-to-head/2026-04-19.png")
async def head_to_head_2026_04_19():
    return FileResponse(
        "img/head-to-head/nba-head-to-head-2026-04-19.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
...
async def head_to_head_2026_04_07():
    return FileResponse(
        "img/head-to-head/nba-head-to-head-2026-04-07.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-head-to-head/2026-03-31.png")
async def head_to_head_2026_03_31():
    return FileResponse(
        "img/head-to-head/nba-head-to-head-2026-03-31.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
...
@app.get("/nba-east-vs-west/2026-04-21.png")
async def east_vs_west_2026_04_21():
    return FileResponse(
        "img/east-vs-west/nba-east-vs-west-2026-04-21.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-east-vs-west/2026-04-19.png")
...
@app.get("/nba-east-vs-west/2026-04-07.png")
async def east_vs_west_2026_04_07():
    return FileResponse(
        "img/east-vs-west/nba-east-vs-west-2026-04-07.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )


@app.get("/nba-east-vs-west/2026-03-31.png")
async def east_vs_west_2026_03_31():
    return FileResponse(
        "img/east-vs-west/nba-east-vs-west-2026-03-31.png",
        media_type="image/png",
        headers=CACHE_HEADERS,
    )
